...
const punggolFireMilestones: IncidentMilestone[] = [
  ...
  milestone("post-fire-sweep", { timestamp: "00:08", displayTime: "post-fire 00:08", sourceType: "footage", sourceLabel: "Wei Jie POV / Bodycam A", status: "confirmed", notes: "Post-fire sweep beside the adjacent building.", evidenceRef: "demo-punggol-post-fire-a-08s-sweep" }),
  milestone("welfare-check", { timestamp: "00:18", displayTime: "post-fire 00:18", sourceType: "footage", sourceLabel: "Wei Jie POV / Bodycam A", status: "confirmed", notes: "Responders conduct a welfare-check interaction beside the building.", evidenceRef: "demo-punggol-post-fire-a-18s-welfare-check" }),
  milestone("verbal-aggression", { timestamp: "00:31", displayTime: "post-fire 00:31", sourceType: "footage", sourceLabel: "Wei Jie POV / Bodycam A", status: "confirmed", notes: "A drunk/aggressive man is present during the welfare-check sequence.", evidenceRef: "demo-punggol-post-fire-a-31s-verbal-aggression" }),
  milestone("physical-contact", { timestamp: "00:37", displayTime: "post-fire 00:37", sourceType: "footage", sourceLabel: "Wei Jie POV + Hafiz POV", status: "confirmed", notes: "Wei Jie POV shows the drunk/aggressive man making physical contact / shove against Hafiz; Hafiz POV shows impact and recovery.", evidenceRef: "demo-punggol-post-fire-a-37s-physical-contact" }),
  ...
  incidentObjects: [
    {
      ...
      summary: "Wei Jie POV records the post-fire sweep beside the adjacent building.",
    ...
    },
    {
      ...
      summary: "Wei Jie POV shows the drunk/aggressive man making physical contact / shove against Hafiz; Hafiz POV shows impact and recovery.",
    ...
    },
    {
      ...
      summary: "Hafiz POV shows impact/recovery and crew actions after contact.",
