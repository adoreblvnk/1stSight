...
const sharedMilestoneLabels: Record<IncidentMilestone["id"], string> = {
  ...
  "physical-contact": "Physical contact evidence",
  "crew-spacing": "Crew spacing / recovery",
...
const punggolFireMilestones: IncidentMilestone[] = [
  milestone("call-received", { timestamp: "13:56:10", displayTime: "13:56", sourceType: "dispatch-system", sourceLabel: "Caller intake log", status: "confirmed", notes: "Caller reports small landed house fire next to a building; no injuries reported." }),
  ...
  milestone("first-jet-out", { timestamp: "14:02:10", displayTime: "14:02", sourceType: "footage", sourceLabel: "Bodycam A", status: "confirmed", notes: "Hose-line movement and responders are visible near the side of the house.", evidenceRef: "demo-fire-a-12s-line-position" }),
  milestone("ba-entry", { timestamp: "14:04:06", displayTime: "14:04", sourceType: "footage", sourceLabel: "Bodycam C", status: "confirmed", notes: "Entry-control visibility conditions recorded.", evidenceRef: "demo-fire-c-63_25s-entry-control" }),
  milestone("damping-down", { displayTime: "Pending officer input", sourceType: "officer-entered", sourceLabel: "Officer review input required", status: "pending", notes: "Damping-down record pending." }),
  milestone("post-fire-sweep", { timestamp: "00:07.75", displayTime: "post-fire 00:08", sourceType: "footage", sourceLabel: "Tze Kai POV / Bodycam A", status: "confirmed", notes: "Post-fire corridor sweep beside the adjacent building.", evidenceRef: "demo-punggol-post-fire-a-7_75s-sweep" }),
  milestone("welfare-check", { timestamp: "00:19.25", displayTime: "post-fire 00:19", sourceType: "footage", sourceLabel: "Tze Kai POV / Bodycam A", status: "confirmed", notes: "Welfare-check interaction visible beside the building.", evidenceRef: "demo-punggol-post-fire-a-19_25s-welfare-check" }),
  milestone("unsafe-proximity", { timestamp: "00:36.25", displayTime: "post-fire 00:36", sourceType: "footage", sourceLabel: "Tze Kai POV / Bodycam A", status: "confirmed", notes: "Unsafe proximity is visible during the welfare-check sequence.", evidenceRef: "demo-punggol-post-fire-a-36_25s-unsafe-proximity" }),
  milestone("physical-contact", { timestamp: "00:45.5", displayTime: "post-fire 00:46", sourceType: "footage", sourceLabel: "Tze Kai POV + Joseph POV", status: "confirmed", notes: "Both POVs support the same responder-safety moment: close proximity, physical-contact evidence, and recovery perspective.", evidenceRef: "demo-punggol-post-fire-b-45_5s-physical-contact" }),
  milestone("crew-spacing", { timestamp: "00:47.5", displayTime: "post-fire 00:48", sourceType: "footage", sourceLabel: "Joseph POV / Bodycam B", status: "confirmed", notes: "Crew spacing and recovery actions follow the physical-contact moment.", evidenceRef: "demo-punggol-post-fire-b-47_5s-spacing-maintained-after-contact" }),
  milestone("police-support-notified", { timestamp: "00:48", displayTime: "post-fire 00:48", sourceType: "officer-entered", sourceLabel: "Officer / GC guidance", status: "confirmed", notes: "Confirm on-site police support for the welfare-check scene through the officer / Ground Commander." }),
...
const woodlandsMedicalMilestones: IncidentMilestone[] = [
  ...
  milestone("after-patient-assessment", { timestamp: "00:22.5", displayTime: "00:22.5", sourceType: "footage", sourceLabel: "Bodycam W1", status: "confirmed", notes: "Assessment/proximity review point requires officer interpretation.", evidenceRef: "med-woodlands-a-22_5s" }),
...
export const scenarioState: ScenarioState = {
  ...
  title: "Punggol landed house fire response review",
  ...
  incidents: [
    {
      ...
      type: "fire",
      title: "Caller report: landed house fire",
      severity: "watch",
      status: "live",
      startTime: "13:56:10",
      location: "21 Punggol Field Walk",
      position: { lat: 1.415, lng: 103.9105 },
      summary: "Caller reports a small fire at a landed house next to a building at 21 Punggol Field Walk. Caller remains outside and reports no visible injuries.",
      tags: ["fire response", "deployment"],
      objectIds: ["obj-bodycam-a-attack", "obj-flame-spread", "obj-bodycam-c-entry-control", "obj-punggol-post-fire-sweep", "obj-punggol-welfare-check", "obj-punggol-unsafe-proximity", "obj-punggol-physical-contact", "obj-punggol-crew-spacing", "obj-punggol-police-support-guidance"],
      evidenceIds: ["demo-fire-a-12s-line-position", "demo-fire-b-76_5s-escalation-etf", "demo-fire-b-130_75s-sustained-escalation", "demo-fire-c-63_25s-entry-control", "demo-punggol-post-fire-a-7_75s-sweep", "demo-punggol-post-fire-a-19_25s-welfare-check", "demo-punggol-post-fire-a-36_25s-unsafe-proximity", "demo-punggol-post-fire-a-45_25s-contact-evidence", "demo-punggol-post-fire-b-45_5s-physical-contact", "demo-punggol-post-fire-b-46_5s-recovery-withdrawal", "demo-punggol-post-fire-b-47_5s-spacing-maintained-after-contact"],
  ...
  incidentObjects: [
    {
      ...
      source: "Tze Kai POV / Bodycam A",
      summary: "Tze Kai POV records a clear post-fire corridor sweep beside the adjacent building.",
      evidenceId: "demo-punggol-post-fire-a-7_75s-sweep",
    ...
    },
    {
      ...
      timestamp: "post-fire 00:19",
      source: "Tze Kai POV / Bodycam A",
      summary: "Responder footage shows a welfare-check interaction beside the building.",
      evidenceId: "demo-punggol-post-fire-a-19_25s-welfare-check",
      tags: ["responder safety", "medical assistance"],
      reviewState: "selected",
    },
    {
      id: "obj-punggol-unsafe-proximity",
      incidentId: DEFAULT_INCIDENT_ID,
      title: "Unsafe proximity during welfare check",
      timestamp: "post-fire 00:36",
      source: "Tze Kai POV / Bodycam A",
      summary: "The involved person is visible in close proximity during the post-fire welfare-check sequence.",
      evidenceId: "demo-punggol-post-fire-a-36_25s-unsafe-proximity",
    ...
    },
    {
      ...
      timestamp: "post-fire 00:46",
      source: "Tze Kai POV / Bodycam A; Joseph POV / Bodycam B",
      summary: "The two POVs support the same responder-safety moment: close proximity, physical-contact evidence, and recovery perspective.",
      evidenceId: "demo-punggol-post-fire-b-45_5s-physical-contact",
      tags: ["responder safety", "physical contact", "unsafe proximity"],
      reviewState: "pending-review",
    },
    {
      id: "obj-punggol-crew-spacing",
      incidentId: DEFAULT_INCIDENT_ID,
      title: "Crew spacing and recovery",
      timestamp: "post-fire 00:48",
      source: "Joseph POV / Bodycam B",
      summary: "Joseph POV shows recovery and crew spacing actions after the physical-contact moment.",
      evidenceId: "demo-punggol-post-fire-b-47_5s-spacing-maintained-after-contact",
    ...
    },
    {
      ...
      summary: "Confirm on-site police support through the officer / Ground Commander.",
      evidenceId: "demo-punggol-post-fire-b-45_5s-physical-contact",
      tags: ["responder safety", "crew intervention"],
      reviewState: "pending-review",
    },
    {
      ...
      summary: "Bodycam A records responders near the side of the house with a visible hose line.",
      evidenceId: "demo-fire-a-12s-line-position",
    ...
    },
    {
      ...
      summary: "Bodycam B records visible flame growth and later sustained fire escalation.",
      evidenceId: "demo-fire-b-130_75s-sustained-escalation",
    ...
    },
    {
      ...
      timestamp: "14:04:06",
      source: "Jia Jia bodycam",
      summary: "Bodycam C records entry-control visibility conditions, smoke near the access point, and responder positioning during the fire response.",
      evidenceId: "demo-fire-c-63_25s-entry-control",
  ...
  deploymentMarkers: [
    ...
    { id: "punggol-residential", incidentId: DEFAULT_INCIDENT_ID, label: "Punggol house fire", kind: "incident", position: { lat: 1.415, lng: 103.9105 }, status: "live incident" },
  ...
  report: {
    ...
    evidenceIds: ["demo-fire-a-12s-line-position", "demo-fire-b-130_75s-sustained-escalation", "demo-fire-c-63_25s-entry-control", "demo-punggol-post-fire-b-45_5s-physical-contact", "demo-punggol-post-fire-b-47_5s-spacing-maintained-after-contact"],
    reviewState: "pending-review",
    claims: [
      {
        ...
        evidence: "Firefighter A bodycam, Firefighter B bodycam, and Jia Jia bodycam",
      },
      {
