...
const punggolFireMilestones: IncidentMilestone[] = [
  ...
  milestone("first-jet-out", { timestamp: "14:02:10", displayTime: "14:02", sourceType: "footage", sourceLabel: "Bodycam A", status: "confirmed", notes: "Hose-line movement near initial fire area.", evidenceRef: "ev-fire-a-attack" }),
  milestone("ba-entry", { timestamp: "14:04:06", displayTime: "14:04", sourceType: "footage", sourceLabel: "Bodycam C", status: "confirmed", notes: "Entry-control conditions recorded.", evidenceRef: "ev-fire-c-entry-control" }),
  ...
  milestone("post-fire-sweep", { timestamp: "00:08", displayTime: "post-fire 00:08", sourceType: "footage", sourceLabel: "Tze Kai POV / Bodycam A", status: "confirmed", notes: "Post-fire sweep beside the adjacent building.", evidenceRef: "demo-punggol-post-fire-a-08s-sweep" }),
  milestone("welfare-check", { timestamp: "00:18", displayTime: "post-fire 00:18", sourceType: "footage", sourceLabel: "Tze Kai POV / Bodycam A", status: "confirmed", notes: "Responders conduct a welfare-check interaction beside the building.", evidenceRef: "demo-punggol-post-fire-a-18s-welfare-check" }),
  milestone("verbal-aggression", { timestamp: "00:31", displayTime: "post-fire 00:31", sourceType: "footage", sourceLabel: "Tze Kai POV / Bodycam A", status: "confirmed", notes: "A drunk/aggressive man is present during the welfare-check sequence.", evidenceRef: "demo-punggol-post-fire-a-31s-verbal-aggression" }),
  milestone("physical-contact", { timestamp: "00:37", displayTime: "post-fire 00:37", sourceType: "footage", sourceLabel: "Tze Kai POV + Joseph POV", status: "confirmed", notes: "Tze Kai POV shows the drunk/aggressive man making physical contact / shove against Joseph; Joseph POV shows impact and recovery.", evidenceRef: "demo-punggol-post-fire-a-37s-physical-contact" }),
  milestone("de-escalation-restraint", { timestamp: "00:40", displayTime: "post-fire 00:40", sourceType: "footage", sourceLabel: "Joseph POV / Bodycam B", status: "confirmed", notes: "Crew de-escalation and restraint/recovery actions follow the contact moment.", evidenceRef: "demo-punggol-post-fire-b-40s-recovery" }),
  milestone("police-support-notified", { timestamp: "00:44", displayTime: "post-fire 00:44", sourceType: "officer-entered", sourceLabel: "Officer / GC guidance", status: "confirmed", notes: "Notify or confirm on-site police support for the welfare-check scene through the officer / Ground Commander." }),
  ...
  incidentObjects: [
    {
      ...
      summary: "Tze Kai POV records the post-fire sweep beside the adjacent building.",
    ...
    },
    {
      ...
      source: "Tze Kai POV / Bodycam A",
      summary: "A drunk/aggressive man beside the building is captured during the post-fire welfare-check sequence.",
      evidenceId: "demo-punggol-post-fire-a-31s-verbal-aggression",
      tags: ["responder safety", "unsafe proximity", "abuse"],
    ...
    },
    {
      ...
      summary: "Tze Kai POV shows the drunk/aggressive man making physical contact / shove against Joseph; Joseph POV shows impact and recovery.",
    ...
    },
    {
      ...
      summary: "Joseph POV shows impact/recovery and crew actions after contact.",
    ...
    },
    {
      ...
      summary: "Notify or confirm police support through the officer / Ground Commander.",
      evidenceId: "demo-punggol-post-fire-a-37s-physical-contact",
      tags: ["responder safety", "crew intervention"],
      reviewState: "pending-review",
    },
