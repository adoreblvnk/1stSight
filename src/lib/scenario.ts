...
const punggolFireMilestones: IncidentMilestone[] = [
  ...
  milestone("post-fire-sweep", { timestamp: "00:08", displayTime: "post-fire 00:08", sourceType: "footage", sourceLabel: "Wei Jie POV / Bodycam A", status: "confirmed", notes: "Post-fire sweep continues from the same Punggol incident beside the adjacent building using Wei Jie POV footage.", evidenceRef: "demo-punggol-post-fire-a-08s-sweep" }),
  milestone("welfare-check", { timestamp: "00:18", displayTime: "post-fire 00:18", sourceType: "footage", sourceLabel: "Wei Jie POV / Bodycam A", status: "confirmed", notes: "Responders conduct a welfare-check interaction beside the building after the house-fire response; this is footage-derived, not caller context.", evidenceRef: "demo-punggol-post-fire-a-18s-welfare-check" }),
  milestone("verbal-aggression", { timestamp: "00:31", displayTime: "post-fire 00:31", sourceType: "footage", sourceLabel: "Wei Jie POV / Bodycam A", status: "confirmed", notes: "A drunk/aggressive man beside the building is visible/audible in the post-fire welfare-check sequence.", evidenceRef: "demo-punggol-post-fire-a-31s-verbal-aggression" }),
  milestone("physical-contact", { timestamp: "00:37", displayTime: "post-fire 00:37", sourceType: "footage", sourceLabel: "Wei Jie POV + Hafiz POV", status: "confirmed", notes: "Wei Jie POV clearly shows the drunk/aggressive man making physical contact / shove against Hafiz beside the building; Hafiz POV supports the impact and recovery perspective.", evidenceRef: "demo-punggol-post-fire-a-37s-physical-contact" }),
  ...
  incidentObjects: [
    {
      ...
      summary: "Wei Jie POV records the same Punggol incident continuing into a post-fire sweep beside the adjacent building.",
    ...
    },
    {
      ...
      source: "Wei Jie POV / Bodycam A",
      summary: "Responder footage shows a welfare-check interaction beside the building after the fire phase; it is not part of the caller report.",
    ...
    },
    {
      ...
      summary: "Wei Jie POV provides the clearest evidence of the drunk/aggressive man making physical contact / shove against Hafiz beside the building; Hafiz POV supports impact and recovery context.",
    ...
    },
    {
      ...
      summary: "Hafiz POV shows impact/recovery and crew actions immediately after the contact moment beside the building.",
